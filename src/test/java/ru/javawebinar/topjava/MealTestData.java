...
public class MealTestData {
    ...
    public static final Meal USER_ONE = new Meal(START_SEQ, LocalDateTime.of(2015,1,1,0,0,1)
            , "one", 201);

    public static final Meal USER_TWO = new Meal(START_SEQ, LocalDateTime.of(2015,1,1,0,0,1)
            , "two", 202);

    public static final Meal USER_THREE = new Meal(START_SEQ, LocalDateTime.of(2015,1,1,0,0,1)
            , "three", 203);

    public static final Meal USER_FOUR = new Meal(START_SEQ, LocalDateTime.of(2015,1,2,0,0,1)
            , "for", 2004);

    public static final Meal USER_FIVE = new Meal(START_SEQ, LocalDateTime.of(2015,1,2,0,0,1)
            , "five", 205);

    public static final Meal USER_SIX = new Meal(START_SEQ, LocalDateTime.of(2015,1,2,0,0,1)
            , "six", 206);
